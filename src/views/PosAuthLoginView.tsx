...
export const PosAuthLoginView: React.FC<PosAuthLoginViewProps> = ({ auth }) => {
  ...
  const [ownerEmail, setOwnerEmail] = useState<string>('adi.pass855@gmail.com')
  const [ownerPassword, setOwnerPassword] = useState<string>('')
  const [showOwnerPassword, setShowOwnerPassword] = useState<boolean>(false)
  const [regBrand, setRegBrand] = useState<string>('Grounded Coffee')
  const [regEmail, setRegEmail] = useState<string>('adi.pass855@gmail.com')
