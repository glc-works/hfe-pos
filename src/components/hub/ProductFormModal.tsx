        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4 overflow-y-auto flex-1 text-xs">
          ...
          <div className="space-y-2">
            ...
            {stockType === 'recipe_bom' && (
              <div className="p-3 bg-muted/20 border border-border rounded-xl space-y-2 mt-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-foreground">🧪 Resep Bahan Baku (BOM):</span>
                  <Button
                    type="button"
                    variant="outline"
                    size="sm"
                  ...
                  {ingredients.map((ing, idx) => (
                    <div key={idx} className="flex items-center gap-2">
                      <TextInput
                        ...
                        className="flex-1 h-10 px-3 text-xs bg-background border-border rounded-xl"
                      />
                      <TextInput
                        value={ing.amount}
                        onChange={(e) => {
                        ...
                        placeholder="18 Gram"
                        className="w-24 h-10 px-3 text-xs bg-background border-border rounded-xl text-center"
                      />
                      <Button
                        type="button"
                        variant="ghost"
                        ...
                        className="w-10 h-10 min-w-[40px] min-h-[40px] rounded-xl text-muted-foreground hover:text-rose-400"
                      >
          ...
          <div className="grid grid-cols-2 gap-2.5 pt-2 border-t border-border/60">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-muted-foreground block">Stasiun Cetak KDS:</label>
              <select
                value={kdsStation}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-muted-foreground block">Pajak Restoran (PB1):</label>
              <Button
                type="button"
          ...
          {/* Footer Submit (Standard 40px / h-10 Buttons) */}
