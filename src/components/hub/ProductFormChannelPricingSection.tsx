  ...
  return (
    <div className="pt-2 border-t border-border/60">
      <button
        ...
        className="w-full flex items-center justify-between p-2 rounded-lg bg-background hover:bg-muted/80 border border-border text-xs font-semibold text-foreground transition-all cursor-pointer"
      >
        <div className="flex items-center gap-2">
          <Bike className="w-4 h-4 text-amber-500" />
          <span>Atur Harga Saluran Online (GoFood, GrabFood, QR)</span>
        </div>
      ...
      {showChannelPricing && (
        <div className="mt-2.5 p-3 rounded-xl bg-card border border-border space-y-3 animate-fadeIn">
          <div className="flex items-center justify-between text-[11px]">
            <span className="font-bold text-foreground">🛵 Saluran Delivery (GoFood / GrabFood):</span>
            <div className="flex items-center gap-1">
              <span className="text-muted-foreground">Markup Komisi:</span>
              <select
                ...
                className="px-2 py-0.5 bg-muted rounded border border-border text-[11px] font-mono"
              >
          ...
          <div className="flex items-center gap-2">
            <TextInput
              ...
              className="flex-1 h-9 px-3 text-xs bg-background border-border rounded-lg font-mono font-bold"
            />
            {customDeliveryPrice !== null ? (
              <div className="flex items-center gap-1">
                <span className="px-2 py-1 bg-amber-500/10 text-amber-500 border border-amber-500/20 rounded text-[10px] font-bold">
                  ✏️ Kustom
                </span>
                <Button
                  type="button"
              ...
              <span className="px-2 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded text-[10px] font-mono font-bold">
