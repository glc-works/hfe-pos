  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-slate-950/60 p-3.5 rounded-xl border border-slate-800">
      ...
      {category === 'payments' && (
        <>
          <div className="space-y-1">
            <label className="text-[11px] text-slate-400 font-medium">Live Public Key / Client Key</label>
            <input
              type="text"
          ...
          <div className="space-y-1">
            <label className="text-[11px] text-slate-400 font-medium">Live Secret / Server Key</label>
            <input
              type="password"
