...
export const ConnectorsCatalogGrid: React.FC<ConnectorsCatalogGridProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-slate-900/60 p-3 rounded-xl border border-slate-800">
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            <option value="id">🇮🇩 Indonesia (SNAP BI, Jurnal, QRIS, Moka)</option>
            ...
            <option value="us">🇺🇸 USA (Plaid, Stripe, QuickBooks, Toast)</option>
            <option value="eu">🇪🇺 EU (SEPA, Adyen, SAP, Odoo)</option>
          </select>
          ...
          <select
            ...
            className="bg-slate-800 border border-slate-700 text-slate-200 text-xs font-semibold rounded-lg px-3 py-2 outline-none focus:border-sky-500"
          >
            <option value="all">📂 Semua Kategori ({CONNECTORS_DATA.length} Konektor)</option>
            <option value="accounting">Cloud Accounting Bridges (Xero, QBO, SAP)</option>
            <option value="payments">Payment Gateways &amp; QRIS (Stripe, Midtrans)</option>
            <option value="banking">Open Banking &amp; SNAP BI (BCA, Mandiri, PayNow)</option>
            <option value="ecommerce">Omnichannel E-Commerce (Shopify, Alfamart)</option>
            <option value="pos">POS &amp; Kasir Terminal (Moka, Toast, ESB)</option>
            <option value="tax">Tax &amp; E-Invoicing (e-Faktur, Peppol, EmaraTax)</option>
          </select>
        </div>
        ...
        <div className="relative min-w-[240px] flex-1 sm:flex-none">
          ...
          <input
            ...
            placeholder="Cari konektor (BCA, Xero, Stripe, Shopify)..."
      ...
      {/* Grid Cards (Defensive Spatial Isolation & Anti-Collision) */}
              ...
              <div>
                <div className="flex items-start justify-between gap-3 mb-2.5">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {isInstalled && (
                      <Badge variant="secondary" className="text-[9px] px-1.5 py-0.5 text-sky-400 bg-sky-500/20 border-sky-500/40">
                        Active
                      </Badge>
                    )}
                    <Badge
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={`flex-1 gap-1 ${
                      isInstalled
                        ? 'text-sky-400 border border-slate-700'
                  ...
                  <Button
                    ...
                    className="border-sky-500/30 bg-sky-500/10 text-sky-400 hover:bg-sky-500/20 hover:text-sky-300 gap-1"
                  >
