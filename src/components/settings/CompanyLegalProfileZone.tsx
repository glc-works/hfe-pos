  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 sm:p-6 flex flex-col gap-5 shadow-xl animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* 1. NAMA BADAN HUKUM */}
        <TextInput
          label={t.settings.ptLegalName}
          leadingIcon={<Building2 className="w-4 h-4 text-indigo-400" />}
        ...
        <TextInput
          ...
          leadingIcon={<Store className="w-4 h-4 text-amber-400" />}
        ...
        {/* 3. NPWP E-FAKTUR */}
        <TextInput
          label={t.settings.taxIdNpwp}
          leadingIcon={<FileCheck className="w-4 h-4 text-emerald-400" />}
        ...
        {/* 4. NIB PERMIT */}
        <TextInput
          label={t.settings.nibPermit}
          leadingIcon={<ShieldCheck className="w-4 h-4 text-blue-400" />}
