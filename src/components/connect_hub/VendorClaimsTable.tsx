...
import { ShieldCheck, Plus, CheckCircle2, AlertTriangle, ExternalLink, Shield } from 'lucide-react'
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3 bg-slate-900/60 p-3 rounded-xl border border-slate-800">
        ...
        <button
          ...
          className="py-1.5 px-3 bg-emerald-500 hover:bg-emerald-400 text-slate-950 rounded-lg text-xs font-bold transition-colors flex items-center gap-1.5 shadow-sm"
        >
                ...
                <td className="py-3 px-4 text-right">
                  {claim.status === 'pending_dns' ? (
                    <button
                      ...
                      className="py-1 px-2.5 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 rounded-lg text-xs font-semibold transition-colors"
                    >
                      Approve Proof
                    </button>
                  ) : (
                    <button
                      ...
                      className="py-1 px-2.5 bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 rounded-lg text-xs font-semibold transition-colors"
                    >
                      View Proof
                    </button>
                  )}
