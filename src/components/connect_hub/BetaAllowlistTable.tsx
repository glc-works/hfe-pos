...
import { Plus, Trash2, Key, CheckCircle2, ShieldAlert, Sparkles } from 'lucide-react'
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3 bg-slate-900/60 p-3 rounded-xl border border-slate-800">
        ...
        <button
          ...
          className="py-1.5 px-3 bg-amber-500 hover:bg-amber-400 text-slate-950 rounded-lg text-xs font-bold transition-colors flex items-center gap-1.5 shadow-sm"
        >
                ...
                <td className="py-3 px-4 text-right">
                  {enr.status === 'active' && (
                    <button
                      ...
                      className="py-1 px-2.5 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/30 rounded-lg text-xs font-semibold transition-colors"
                    >
                      Revoke
                    </button>
                  )}
