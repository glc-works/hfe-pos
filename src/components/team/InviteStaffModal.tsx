  ...
  const rolesList = [
    {
      ...
      emoji: '👑',
      icon: Crown,
      description: 'Akses penuh ke semua menu, Cafe Settings, Laporan Keuangan, & Pengaturan Tim.',
    },
    {
      ...
      emoji: '💵',
      icon: Landmark,
      description: 'Akses ke Barista POS, pembayaran QRIS/Cash, & Rekonsiliasi Kas Shift.',
    },
    {
      ...
      emoji: '☕',
      icon: Coffee,
      description: 'Akses khusus Layar KDS Barista untuk meracik & bump pesanan minuman.',
    },
    {
      ...
      description: 'Akses khusus Layar KDS Dapur untuk memasak & bump pesanan makanan.',
    },
    {
      ...
      emoji: '🍽️',
      icon: Footprints,
      description: 'Akses pesan meja mobile via tablet & tagging nomor kursi pelanggan.',
    },
    {
      ...
      emoji: '📋',
      icon: ClipboardCheck,
      description: 'Akses ke layar audit QC sebelum pesanan disajikan ke meja pelanggan.',
    },
  ]
