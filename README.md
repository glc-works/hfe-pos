...
Seluruh panduan teknis, tata kelola komponen UI, dan standar arsitektur dikelola secara modular pada dokumen-dokumen resmi berikut:

| Kategori Panduan | Tautan Dokumen | Deskripsi & Isi Panduan |
| :--- | :--- | :--- |
| 🚀 **Onboarding & Fast Entry** | [`docs/active/reference/getting-started-guide.md`](docs/active/reference/getting-started-guide.md) | Panduan Day-0 Fast Entry 60 detik & Getting Started Hub interaktif. |
| 📦 **Instalasi & Deployment** | [`docs/active/reference/installation-guide.md`](docs/active/reference/installation-guide.md) | Panduan setup Vite dev server, Storybook living suite, dan build produksi. |
| 🔄 **Migrasi UI & Data** | [`docs/active/reference/migration-guide.md`](docs/active/reference/migration-guide.md) | Panduan import CSV produk, konfigurasi meja, dan adaptasi 6-Tier Architecture. |
| 🏛️ **Arsitektur & Tenancy** | [`docs/active/architecture/hfe-ecosystem-business-and-tenancy-model.md`](docs/active/architecture/hfe-ecosystem-business-and-tenancy-model.md) | Spesifikasi model tenancy 4-level, billing relasional, dan double-entry posting. |
| 🛡️ **Contributor Safety & SOP** | [`docs/active/standards/contributor-safety-guide.md`](docs/active/standards/contributor-safety-guide.md) | Pantangan (*What NOT to do*) & SOP kerja kontributor (Implementation-First). |
| 📏 **Standar UI & Rekayasa POS** | [`docs/active/standards/POS-ENG-STD-001.md`](docs/active/standards/POS-ENG-STD-001.md) | Standar isolasi spasial, 4-kuadran, angka tabular, dan headless primitives. |
